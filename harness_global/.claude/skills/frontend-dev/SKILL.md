---
name: frontend-dev
description: "프론트엔드 기능 개발, 버그 수정, 컴포넌트 구현, API 연동 작업을 요청하면 반드시 이 스킬을 사용하라. 컴포넌트 만들어줘, 훅 수정해줘, 버그 고쳐줘, API 연결해줘, 페이지 추가해줘, 기능 구현해줘, 다시 실행해줘, 이전 결과 수정해줘 등 프론트엔드 코드 작업 요청에 모두 적용된다. 요청 앞에 'low:', 'mid:', 'high:' 레벨 키워드가 붙은 경우에도 반드시 이 스킬을 사용하라."
---
